      ...
      case "create":
        return {
          ...
          content: JSON.stringify({
            ...
            // EXTEND: sagaLogEntry: { compensatingAction: "delete", taskId }
          }),
        };
      ...
      case "update":
        return {
          ...
          content: JSON.stringify({
            ...
            // EXTEND: sagaLogEntry: { compensatingAction: "revert", previousStatus }
          }),
        };
            ...
            tasks: [
              {
                ...
                description: "定期校验釜内温度传感器精度，确保测量准确",
                status: "in_progress",
                priority: "P1",
                assignee: "张工",
              ...
              },
              {
                id: "WO-002",
                title: "R-101夹套清洗",
                description: "夹套结垢影响换热效率，需化学清洗恢复换热能力",
                status: "pending",
                priority: "P2",
                assignee: "李工",
